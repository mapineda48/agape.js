 ...
 */
export default function FormProvider<T extends object | unknown[] = object>({
  // These props are consumed by Root/ValidationStoreProvider, extracted here to exclude from formProps
  state: _initialState, // eslint-disable-line @typescript-eslint/no-unused-vars
  schema: _schema, // eslint-disable-line @typescript-eslint/no-unused-vars
  mode: _mode, // eslint-disable-line @typescript-eslint/no-unused-vars
  reValidateMode: _reValidateMode, // eslint-disable-line @typescript-eslint/no-unused-vars
  onValidationError,
  children,
  ...formProps
}: Props<T>) {
 ...
 */
export interface Props<T extends object | unknown[] = object>
