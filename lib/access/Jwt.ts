...
export default class Jwt {
  ...
  constructor(options: string | JwtOptions) {
    ...
    const config: JwtOptions = typeof options === "string"
      ? { secret: options }
      : options;
   ...
   */
  public async generateToken<T extends Record<string, unknown>>(payload: T): Promise<string> {
   ...
   */
  public async verifyToken<T extends TokenPayload = TokenPayload>(token: string): Promise<T> {
