...
--> statement-breakpoint
CREATE TABLE "agape_app_development_demo"."hr_employee_roles" (
	"employee_id" integer NOT NULL,
	"role_id" integer NOT NULL,
	CONSTRAINT "hr_employee_roles_employee_id_role_id_pk" PRIMARY KEY("employee_id","role_id")
);
--> statement-breakpoint
CREATE TABLE "agape_app_development_demo"."hr_role" (
	"id" serial PRIMARY KEY NOT NULL,
	"code" varchar(10) NOT NULL,
	"name" varchar(100) NOT NULL,
	"description" text,
...
ALTER TABLE "agape_app_development_demo"."hr_employee_roles" ADD CONSTRAINT "hr_employee_roles_employee_id_hr_employee_id_fk" FOREIGN KEY ("employee_id") REFERENCES "agape_app_development_demo"."hr_employee"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "agape_app_development_demo"."hr_employee_roles" ADD CONSTRAINT "hr_employee_roles_role_id_hr_role_id_fk" FOREIGN KEY ("role_id") REFERENCES "agape_app_development_demo"."hr_role"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "agape_app_development_demo"."inventory_movement" ADD CONSTRAINT "inventory_movement_user_id_hr_employee_id_fk" FOREIGN KEY ("user_id") REFERENCES "agape_app_development_demo"."hr_employee"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
