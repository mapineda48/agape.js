...
ALTER TABLE "agape_app_development_demo"."staff_employee" ADD CONSTRAINT "staff_employee_person_id_person_id_fk" FOREIGN KEY ("person_id") REFERENCES "agape_app_development_demo"."person"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "agape_app_development_demo"."staff_employee_roles" ADD CONSTRAINT "staff_employee_roles_role_id_staff_role_id_fk" FOREIGN KEY ("role_id") REFERENCES "agape_app_development_demo"."staff_role"("id") ON DELETE no action ON UPDATE no action;