...
CREATE TABLE "agape_app_demo_development"."access_user" (
	...
	CONSTRAINT "access_user_username_unique" UNIQUE("username")
);
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "agape_app_demo_development"."access_user" ADD CONSTRAINT "access_user_employee_id_staff_employee_id_fk" FOREIGN KEY ("employee_id") REFERENCES "agape_app_demo_development"."staff_employee"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
