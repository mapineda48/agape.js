...
VARLIST='${AGAPE_CDN_HOST} ${AGAPE_FQDN} ${AGAPE_EMAIL_ACME} ${AGAPE_ADMIN} ${AGAPE_PASSWORD} ${AGAPE_HOOK} ${AGAPE_SECRET} ${STORAGE_ACCOUNT_NAME} ${STORAGE_ACCOUNT_KEY} ${STORAGE_CONNECTION_STRING} ${NEON_DATABASE_URI} ${NGROK_AUTHTOKEN} ${NGROK_DEV_DOMAIN}'
