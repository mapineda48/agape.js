...
import { upsertEmployee, getEmployeeById } from "@agape/hr/employee";
...
/**
 * Form state interface for Employee editing.
 */
...
export default function EditEmployeePage(props: Props) {
  ...
  const initialData = {
    ...
    avatar: props.employee.avatarUrl || undefined,
    ...
    <Fragment>
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 py-8">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Form */}
          <Form<EditEmployeeFormState> state={initialData as any}>
            <EmployeeForm
...
function EmployeeForm({
  ...
  const [photoPreview] = useState<string | null>(initialAvatar);

  // Auto-select Cedula document type for display if not set (though it should be set)
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="relative">
              ...
              {/* Find the name of the currently selected document type or fallback to Cedula */}
              <input
                type="text"
                value={
